---
slug: Guide to using Material UI with Docusaurus
title: "Guide: Material UI with Docusaurus"
authors: [reap3r]
tags:
  [
    material ui,
...
After fighting Docusaurus and Material UI in the creation of this website - I decided to write a post explaining how to use them together so **_you_** don't have to go through the same struggle I did.
