---
title: "Guide: Using Material UI with Docusaurus"
...
We need to import the MUI theme, and wrap it around the entire website. This can be done by [swizzing](https://docusaurus.io/docs/swizzling#wrapper-your-site-with-root) the `<Root>`. Then make your `Root.js` look like below.
